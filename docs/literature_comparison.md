# Literaturvergleich: VPP- und Speicherbewertung im deutschen Kontext
...
|---|---:|---|
| Merchant BESS, 100 MWh / 50 MW | Intrinsic 9,213 EUR/Tag | ca. 67,257 EUR/MW-Jahr annualisiert, wenn dieser Beispieltag repraesentativ waere |
| Merchant BESS | Rolling 8h = 100.0% Intrinsic-Capture | Volles 8h-Fenster reicht fuer das 24h-Beispielprofil |
| Merchant BESS | Rolling 4h = 93.5%, 6h = 97.6% | Wertverlust durch begrenzten Look-ahead in diesem Day-Ahead-artigen Setup |
| Merchant BESS | MC 12,162 EUR/Tag, 132.0% Capture | Sensitivitaet gegen synthetische Pfadvolatilitaet, kein executable uplift |
| Renewable Hybrid | Intrinsic 15,892 EUR/Tag, Rolling 99.8% | Asset-Mix aus RES und BESS mit geringer Look-ahead-Suboptimalitaet |
...
Die annualisierte Merchant-BESS-Zahl ist nur eine Skalierung:
...
|---|---|---:|---|
| Speicherarbitrage als Investment-Case | Metz & Saraiva finden fuer deutsche 15-/60-min-Intraday-Arbitrage, dass historische Arbitrage allein die Investition nicht rechtfertigt. | Merchant BESS Intrinsic: 67,257 EUR/MW-Jahr, wenn der synthetische Beispieltag annualisiert wuerde. | Die Repo-Zahl ist eine obere Dispatch-Schranke ohne CAPEX, Lebensdauer und Markttiefe. Sie darf die Literatur nicht als Profitabilitaetsnachweis ersetzen. |
| Perfect-Foresight-Wert vs. ausfuehrbare Intraday-Strategie | Fraunhofer ITWM berichtet fuer 2020-2022 mehr als 5x hoehere Ex-post-Gewinne gegenueber Pair Trading; haeufigere Optimierung erhoeht Ex-post-Gewinne um ca. 25-40%, reale Gewinne aber nur deutlich weniger. | Merchant BESS Rolling verliert nur 6.5% bei 4h und 2.4% bei 6h gegenueber Intrinsic. | Das Repo bildet stundenbasierte Preiszeitreihen ab, nicht Orderbuch-Mikrostruktur. Der kleine Gap ist plausibel fuer das Beispiel, aber nicht auf kontinuierlichen Intraday-Handel uebertragbar. |
| Multi-Market-Koordination DA/ID | Finnah et al. und Loehndorf/Wozabal zeigen, dass integrierte DA-/ID-Optimierung gegen sequentielle oder Einzelmarkt-Benchmarks wertvoll ist. | Merchant BESS MC liegt 32.0% ueber Intrinsic, Rolling 8h bei 100.0%. | Der MC-Uplift ist Volatilitaetssensitivitaet, kein Coordination Value. Fuer Vergleichbarkeit braucht das Repo ein explizites DA/ID-Bidding-Modul. |
| Sommerlicher VPP-Beitrag | Candra et al. berichten fuer VPP-Konfigurationen im deutschen Markt sommerliche Day-Ahead-Contribution-Margins bis ca. 14 EUR/MWh, waehrend Winter-/Futures-Faelle haeufig negativ bleiben. | Summer Renewable Hybrid: 9,033 EUR/Tag Intrinsic, Capture Price 53.93 EUR/MWh, ca. 49.7 EUR je exportierter MWh Cashflow. | Richtung und Saisonalitaet passen, die Kennzahl aber nicht: Repo-Cashflow je Export-MWh ist keine produktbezogene Contribution Margin und enthaelt keine Biogas-/Futures-Komponente. |
...
|---|---|---|---|
| Metz & Saraiva (2018), *Electric Power Systems Research* | Batteriespeicher-Arbitrage in deutschen 15- und 60-Minuten-Intraday-Auktionen | MIP-Dispatch mit 15-min Zeitschritten, negative Preise, parallele Maerkte und Zyklus-/Kalenderlebensdauer; historische Arbitrage allein reicht nach ihren Ergebnissen nicht zur Rechtfertigung der Investition. | Unser Batterie-DP ist fuer Energiearbitrage konsistent, aber einfacher: keine parallelen 15/60-min Auktionen, keine CAPEX-Amortisation. Die hohen Merchant-BESS-Capture-Werte sind daher eher obere Sensitivitaeten als Profitabilitaetsnachweis. |
| Finhold, Heller & Leithaeuser (Fraunhofer ITWM, 2023), *Journal of Energy Markets* | Deutscher kontinuierlicher Intraday-Markt, 15-min Produkte, Orderbuch-Arbitrage | Ex-post Perfect Foresight erzeugt im 2020-2022 Datensatz im Mittel mehr als das Fuenffache des Pair-Trading-Gewinns; haeufigere Optimierung erhoeht Ex-post-Gewinne um ca. 25-40%. | Unser Intrinsic-vs-Rolling-Gap ist deutlich kleiner: bei Merchant BESS nur 2.4% Wertverlust im 6h-Fenster und 6.5% im 4h-Fenster. Das ist plausibel, weil unser Setup stundenbasiert und preiszeitreihenorientiert ist, waehrend die Fraunhofer-Arbeit mikrostrukturelles Orderbuch-Trading betrachtet. |
| Finnah, Goensch & Ziel (University of Duisburg-Essen, 2022), *European Journal of Operational Research* | Integriertes Day-Ahead-/Intraday-Self-Schedule-Bidding fuer Speicher in Deutschland | ADP fuer hochdimensionale Preisprognosen; integriertes Trading in beiden Auktionsmaerkten uebertrifft Einzelmarkt- und sequentielle Optimierung; Receding-Horizon-Erwartungsmodell ist ein starker Benchmark. | Unser `rolling_intrinsic` ist konzeptionell naeher am Receding-Horizon-Benchmark als an ADP. Der MC-Policy-Vergleich zeigt bei vol=0.20 einen Perfect-vs-Rolling-Abstand von ca. 5.6% (13,866 vs. 13,089 EUR), aber ohne DA/ID-Kopplung und ohne Preisforecast-State. |
| Loehndorf & Wozabal (TUM, 2023), *Operations Research* | Koordiniertes Multi-Market-Bidding fuer Speicher | Multistage Stochastic Programming mit DA-Auktion und kontinuierlichem Intraday; koordinierte Kapazitaetsreservierung ist besonders wertvoll bei hoher Intraday-Volatilitaet, Liquiditaet und Price Impact; fuer kleine Batterien ist Intraday oft ausreichend. | Unsere Methoden koennen Intraday-Volatilitaet als MC-Sensitivitaet zeigen, aber noch keine koordinierte DA/ID-Kapazitaetsreservierung. Der Merchant-BESS-MC-Uplift von 32.0% ist deshalb kein Ersatz fuer den in dieser Literatur betrachteten Coordination Value. |
